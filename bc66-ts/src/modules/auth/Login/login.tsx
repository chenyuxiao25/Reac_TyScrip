...
import { CurrentUser, UseLoginRequest } from "../../../interfaces/user.interface";
import { useAppDispatch } from "../../../redux/hook";
import { setUser } from "../../../redux/slices/user.slice";
import { setLocalStorage } from "../../../untils";
interface FormValue {
    username: string,
    password : string,
}
...
const Login = () => {
    ...
    const { mutate: handleLogin } = useMutation({
        mutationFn: (payload: UseLoginRequest) => userApi.login(payload),
